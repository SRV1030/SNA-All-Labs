# AIM: TO ANALYSE THE INFORMATION DIFFUSION BY INCORPORATING THE FOLLOWING EPIDEMIC
# MODELS AND DETERMINE THE BEST SUITABLE MODEL FOR REAL‐EORLD SCENARIOS:
# EPIDEMIC MODELS: SUSCEPTIBLE INFECTED (SI), SUSCEPTIBLE INFECTED RECOVERED (SIR), AND
# SUSCEPTIBLE INFECTED SUSCEPTIBLE (SIS) AND LINEAR CASCADES (LC).
