# AIM: TO SHOW THE NUMBER OF PREDICTED LINKS WITH FOLLOWING LINK PREDICTION METHODS:
# PREDICTION METHODS: COSINE SIMILARITY OR SALTON INDEX, ADAMIC‐ADAR INDEX, JACCARD
# COEFFICIENT, PREFERENTIAL ATTACHMENT, RESOURCE ALLOCATION INDEX
